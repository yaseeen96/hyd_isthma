                ...
                <form action="{{ $role->id ? route('permissions.update', $role->id) : route('permissions.store') }}"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" readonly
                                        value="{{ old('name', $role->name) }}" required true />
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    <div class="table-responsive">
                                        <table
                                            class=" nowrap table table-bordered table-hover  dtr-inline collapsed text-center">
                                            <thead>
                                                <tr>
                                                    <th>Module</th>
                                                    <th>Create</th>
                                                            ...
                                                            @if (str_contains($permission, $group))
                                                                ...
                                                                <td>
                                                                    <input type="checkbox" name="permissions[]"
                                                                        {{ in_array($permission->name, $role_permissions) ? 'checked="checked"' : '' }}
                            ...
                            <div class="col-lg-12">
                                <button class="btn btn-purple  mr-2">{{ $role->id ? 'Update' : 'Save' }}</button>
