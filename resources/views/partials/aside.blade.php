          ...
          <nav class="mt-2">
              ...
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  @if (auth()->user()->can('View SessionThemes') ||
                          ...
                          auth()->user()->id == 1)
                      <li
                          class="nav-item  {{ str_contains('sessiontheme programSpeakers programs sessionRegistration', $urlsegment) ? 'menu-open' : '' }}">
                          <a href="#"
                              class="nav-link  {{ str_contains('sessiontheme programSpeakers programs sessionRegistration', $urlsegment) ? 'active' : '' }}">
                          ...
                          <ul class="nav nav-treeview">
                              ...
                              @if (auth()->user()->can('View Enrollments') || auth()->user()->id == 1)
                                  <li class="nav-item">
                                      <a href="{{ route('sessionRegistration.index') }}"
                                          class="nav-link {{ in_array(request()->route()->getName(), ['sessionRegistration.index', 'sessionRegistration.edit', 'sessionRegistration.create']) ? 'active' : '' }}">
                                          <i class="nav-icon fas fa-user"></i>
                                          <p>
                                              Enrollments
                                          </p>
                  ...
                  {{-- QR CODES --}}
                  @if (auth()->user()->can('View QrOperators') ||
                          auth()->user()->can('View CheckInOutPlaces') ||
                          auth()->user()->can('View ScannEntires') ||
                          auth()->user()->id == 1)
                      <li
                          class="nav-item  {{ str_contains('qrOperators checkInOutPlaces checkInOutEntries position-report total-check-in-out-report total-count-by-place', $urlsegment) ? 'menu-open' : '' }}">
                          <a href="#"
                              class="nav-link  {{ str_contains('qrOperators checkInOutPlaces checkInOutEntries position-report total-check-in-out-report total-count-by-place', $urlsegment) ? 'active' : '' }}">
                          ...
                          <ul class="nav nav-treeview">
                              ...
                              @endif
                              @if (auth()->user()->can('View ScannEntires') ||
                                      auth()->user()->can('Edit ScannEntires') ||
                                      auth()->user()->can('Create ScannEntires') ||
                                      auth()->user()->can('Delete ScannEntires') ||
                                      auth()->user()->id == 1)
                                  <li class="nav-item">
                              ...
                              <li class="nav-item">
                                  <a href="{{ route('total-count-by-place') }}"
                                      class="nav-link {{ in_array(request()->route()->getName(), ['total-count-by-place']) ? 'active' : '' }}">
                                      <i class="nav-icon fas fa-person-booth"></i>
                                      <p>
                                          Count By Place report
                                      </p>
                                  </a>
                              </li>
                          </ul>
                  ...
                  @if (auth()->user()->can('View Faq') ||
                          auth()->user()->can('Edit Faq') ||
                          auth()->user()->can('Create Faq') ||
                          auth()->user()->can('Delete Faq') ||
                          auth()->user()->id == 1)
                      <li class="nav-item">
                          <a href="{{ route('faq.index') }}"
                              class="nav-link {{ in_array(request()->route()->getName(), ['faq.index', 'faq.create', 'faq.edit', 'faq.delete']) ? 'active' : '' }}">
