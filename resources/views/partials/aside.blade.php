      ...
      <div class="sidebar">
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  @if( auth()->user()->can('Create Members') || auth()->user()->can('View Members') || auth()->user()->can('Edit Members') || auth()->user()->can('Delete Members') || auth()->user()->id == 1)  
                  <li class="nav-item">
                  ...
                  @if( auth()->user()->can('Create Registrations') || auth()->user()->can('View Registrations') || auth()->user()->can('Edit Registrations') || auth()->user()->can('Delete Registrations') || auth()->user()->id == 1)  
                  <li class="nav-item">
                  ...
                  @if( auth()->user()->can('Create Permissions') || auth()->user()->can('View Permissions') || auth()->user()->can('Edit Permissions') || auth()->user()->can('Delete Permissions') || auth()->user()->id == 1)  
                  <li class="nav-item">
                ...
                @if( auth()->user()->can('Create Users') || auth()->user()->can('View Users') || auth()->user()->can('Edit Users') || auth()->user()->can('Delete Users') || auth()->user()->id == 1)  
                <li class="nav-item">
